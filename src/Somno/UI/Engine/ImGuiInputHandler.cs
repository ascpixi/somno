...
internal class ImGuiInputHandler
{
    ...
    public bool ProcessMessage(WindowMessage msg, nuint wParam, nint lParam)
    {
    ...
    private static void UpdateMousePosition(ImGuiIOPtr io, nint handleWindow)
    {
    ...
    private static int GetWheelDeltaParam(nuint wParam) => ((int)wParam) >> 16;

    private static int GetXButtonWParam(nuint wParam) => ((int)wParam) >> 16;
}
